# 0098springboot大型商场应急预案管理系统

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV16ia6epENY&bvid=BV16ia6epENY&cid=500001610579766&p=99)
...
Boot框架，MYSQL数据库设计开发，充分保证系统的稳定性。系统具有界面清晰、操作简单，功能齐全的特点，使得大型商场应急预案管理系统管理工作系统化、规范化。本系统的使用使管理人员从繁重的工作中解脱出来，实现无纸化办公，能够有效的提高大型商场应急预案管理系统管理效率。
...
whole development process of emergency plan management system for large
shopping malls. By analyzing the shortage of emergency plan management
system in large shopping malls, a scheme of computer management of
emergency plan management system in large shopping malls is established.
This paper introduces the system analysis part of the emergency plan
management system for large shopping malls, including feasibility
analysis, etc. the system design part mainly introduces the system
function design and database design.

The administrator functions of the emergency plan management system of
large shopping malls include personal center, employee management, plan
information management, plan type management, event type management,
plan type statistical management, event type statistical management and
emergency plan management. Employees can view all kinds of plan
information. So it has certain practicability.
...
operation and complete functions, which makes the emergency plan
management system of large shopping malls systematic and standardized.
The use of this system makes managers free from heavy work and realize
paperless office, which can effectively improve the management
efficiency of emergency plan management system in large shopping malls.

**Keywords:** Emergency plan management system of large shopping malls;
...
[1.1 研究背景 1](#__RefHeading___Toc14145)

[1.2研究目的 1](#__RefHeading___Toc11671)
...
[3.3系统界面分析 6](#__RefHeading___Toc11065)
...
[5.1 员工信息管理 13](#员工信息管理)

[5.2 预案信息管理 14](#预案信息管理)

[5.3 预案类型统计 14](#预案类型统计)

[5.4 事件类型管理 15](#事件类型管理)
...
[]{#__RefHeading___Toc14145 .anchor}1.1 研究背景

随着计算机技术的发展以及计算机网络的逐渐普及，互联网成为人们查找信息的重要场所，二十一世纪是信息的时代，所以信息的管理显得特别重要。因此，使用计算机来管理大型商场应急预案管理系统的相关信息成为必然。开发合适的大型商场应急预案管理系统，可以方便管理人员对大型商场应急预案管理系统的管理，提高信息管理工作效率及查询效率，有利于更好的为人们服务。

[]{#__RefHeading___Toc11671 .anchor}1.2研究目的
...
通过对本大型商场应急预案管理系统实行的目的初步调查和分析，提出可行性方案并对其一一进行论证。我们在这里主要从技术可行性、经济可行性、操作可行性等方面进行分析。

### 3.1.1技术可行性

本大型商场应急预案管理系统采用SSM框架，JAVA作为开发语言，是基于WEB平台的B/S架构系统。
...
因此，大型商场应急预案管理系统在开发技术上具有很高可行性，且开发人员掌握了一定的开发技术，所以此系统的开发技术具有可行性。

### 3.1.2经济可行性

本大型商场应急预案管理系统采用的软件都是开源的，这样能够削减很多的精力和资源，降低开发成本。同时对计算机的配置要求也极低，即使是淘汰下来的计算机也能够满足需要，因此，本系统在经济上是完全具有可行性的，所以在经济上是十分可行的。

### 3.1.3操作可行性

本大型商场应急预案管理系统的界面简单易操作，用户只要平时有在用过电脑，都能进行访问和操作。本系统具有易操作、易管理、交互性好的特点，在操作上是非常简单的，因此在操作上具有很高的可行性。
...
此大型商场应急预案管理系统要严格控制管理权限，具体要求如下：

（1）要想对大型商场应急预案管理系统进行管理，首先要依靠用户名和密码在系统中登陆，无权限的用户不可以通过任何方式登录系统和对系统的任何信息和数据进行查看，这样可以保证系统的安全可靠性和准确性。
...
[]{#__RefHeading___Toc11065 .anchor}3.3系统界面分析
...
（2）事件类型信息实体属性图如图4.13所示：

![](media/image6.wmf)

图4.13 事件类型信息实体属性图

（3）预案类型信息实体属性图如图4.14所示：
...
大型商场应急预案管理系统需要后台数据库，下面介绍数据库中的各个表的详细信息：
...
表4.1 对应预案
  ...
  --------------------- -------------- ---- ------------------- --------------------------
     ...
     shouzaileixing      varchar(200)   是         NULL                  受灾类型

      shouzaifanwei        longtext     是         NULL                  受灾范围

     shouzaishijian      varchar(200)   是         NULL                  受灾时间

   shouzairenyuanshumu     int(11)      是         NULL                受灾人员数目
...
![](media/image10.png){width="6.368055555555555in"
...
![](media/image11.png){width="6.371527777777778in"
...
![](media/image12.png){width="6.371527777777778in"
...
![](media/image13.png){width="5.759722222222222in" height="1.78125in"}
...
经过对上述测试结果分析，本系统符合用户需求。所有基本功能点实现，操作简单，操作流程简单合理，产品运行性能良好，是一款值得推广的大型商场应急预案管理系统。
...
首先我要感谢此次指导我的老师，是他的及时纠正我在设计当中出现的问题，使得我的设计高质量完成。指导老师在我本次大型商场应急预案管理系统的开发过程中，为程序、框架的设计、代码等方面以及论文设计提供了很多宝贵的意见，并且为我推荐了许多相关的资料，他的指导和建议使我受益匪浅，通过老师的耐心辅导和指点，我的论文顺利完成，在此，我表示深刻的感谢。
